	...
	private void listenForClientMessages() {
		...
		do {
			...
			case "02":		// Private message
				String whisperer = messageComponent[2];
				System.out.println("Sending private message: " + messageComponent[2] + " to client " + whisperer);
				sendPrivateMessage(messageComponent[2], whisperer, address, port);
				break;
